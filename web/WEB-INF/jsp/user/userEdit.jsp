    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            layui.use(['layer','element','form','upload'],function(){
                ...
                $("#memo").val(user.memo);
                $("#touimg").val(user.headImg);
                $("#touxiang").attr("src",user.headImg);
                    ...
                    userName: function(value, item){ //value：表单的值、item：表单的DOM对象
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                if(parseInt(data) > 0){
                                    if($.trim($("#userName").val()) == user.userName){
                ...
                form.on('submit(*)', function(data){
                    ...
                    layer.confirm('确定添加?', function(index){
                        ...
                        $.ajax({
                            ...
                            dataType:"text",
                            url:"${path}/user/userUpdate.action?id="+user.id,
                            success:function(data){
...
<form class="layui-form" id = "myForm" enctype="multipart/form-data" lay-filter="myform"> <!-- 提示：如果你不想用form，你可以换成div等任何一个普通元素 -->
    ...
    <div class="layui-form-item ">
        ...
        <div class="layui-input-block">
            <input type="text" name="email" placeholder="请输入邮箱" id = "email"  autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item ">
        ...
        <div class="layui-input-block">
            <input type="text" name="memo" id = "memo" placeholder="请输入签名" autocomplete="off" class="layui-input">
        </div>
    </div>
