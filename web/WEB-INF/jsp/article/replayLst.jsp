    ...
    <script type="text/javascript">
        ...
        $(function(){
            layui.use(['layer','element','form','table','laydate'],function() {
                ...
                table.render({
                    elem: '#test'
                    ,url: '${path}/artical/getAllReplay.action' //数据接口
                    ,page: true //开启分页
                    ,limit:10
                    ,limits:[10]
                    // ,toolbar:"#test"
                    ...
                    ,cols: [[ //表头
                        ...
                        {field: 'pingLun', title: '所属评论',align:"center" }
                        ,{field: 'articleTitle', title: '所属文章',align:"center"  }
                        ,{field: 'replayContent', title: '回复内容',align:"center" }
                        ,{field: 'huiName', title: '回复人' ,align:"center"  }
                        ,{field: 'beiName', title: '被回复人' ,align:"center"  }
